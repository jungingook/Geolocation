...
// 비정확
{
    ...
    alias: '혁신광장삼거리',
    type: 'Node',
    link: [{ vertex: 31, dist: 1 }, { vertex: 33, dist: 1 }, { vertex: 49, dist: 1 }, { vertex: 19, dist: 1 }],
    ...
    alias: '미래청정문앞',
    type: 'Node',
    link: [{ vertex: 32, dist: 1 }, { vertex: 34, dist: 1 }, { vertex: 15, dist: 1 }],
    ...
    alias: '창고앞삼거리',
    type: 'Node',
    link: [{ vertex: 35, dist: 1 }, { vertex: 33, dist: 1 }, { vertex: 21, dist: 1 }, { vertex: 3, dist: 1 }],
    ...
    link: [{ vertex: 38, dist: 1 }, { vertex: 1, dist: 1 }, { vertex: 22, dist: 1 }, { vertex: 13, dist: 1 }],
